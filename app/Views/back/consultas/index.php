                ...
                <div class="card bg-dark border-info mb-4">
                    <div class="card-body text-info">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
                            <h1 class="display-5 mb-3 mb-md-0">Gestión de Consultas</h1>
                            <div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <div class="btn-group w-100">
                                                <a href="<?= base_url('back/consultas') ?>" class="btn btn-info <?= !isset($tipo) ? 'active' : '' ?>">
                                                    <i class="fas fa-list me-1"></i> Todos
                                                </a>
                                                <a href="<?= base_url('back/consultas/registrados') ?>" class="btn btn-info <?= isset($tipo) && $tipo == 'registrados' ? 'active' : '' ?>">
                                                    <i class="fas fa-user-check me-1"></i> Clientes
                                                </a>
                                                <a href="<?= base_url('back/consultas/visitantes') ?>" class="btn btn-info <?= isset($tipo) && $tipo == 'visitantes' ? 'active' : '' ?>">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select name="accion" class="form-select me-2" required>
                                                    ...
                                                    <option value="respondida">Marcar respondidas</option>
